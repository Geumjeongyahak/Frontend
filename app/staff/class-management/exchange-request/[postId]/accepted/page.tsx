...
import { ExchangeProposalList } from "@/components/staff/class-management/exchange-request/ExchangeProposalList";
import { ExchangePostDetail } from "@/components/staff/class-management/exchange-request/ExchangeRequestDetail";
    ...
    <PageWrapper>
      <TopButtonRow>
        <Button
          type="button"
          $variant="neutral"
          onClick={() => router.push("/staff/class-management/exchange-request")}
        >
          목록
        </Button>
      </TopButtonRow>
