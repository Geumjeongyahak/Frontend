...
export default function MobileSettingsPage() {
  ...
  return (
    <Page>
      ...
      <PermissionGuide>
        알림 및 위치 권한은 브라우저 정책상 이 화면에 보이는 토글 버튼으로 자유롭게 켜고 끌 수 없습니다.
        이 페이지는 현재 권한 설정 상태를 확인하는 용도로 사용해 주세요.
        <br/>
        <br/>
        1. 토글 버튼을 눌렀을 때, 브라우저에서 권한 허용/차단 여부를 묻는 메시지가 표시되면 해당 메시지를 통해 권한을 설정해 주세요.
        <br/>
        <br/>
        2. 브라우저의 권한 설정 메시지가 표시되지 않는 경우, 
        주소창 왼쪽의 사이트 정보 아이콘 또는 브라우저 설정에서 geumjeongschool.com의 알림 및 위치 권한을 직접 허용해 주세요.
        <br/>
        <br/>
        3. PWA로 접속 중인 경우, 우선 PWA를 종료한 뒤 재접속하여 토글 버튼을 눌러 주세요. 
        그래도 권한 설정 메시지가 표시되지 않는 경우에는 설치된 PWA를 삭제한 후, 
        해당 PWA를 설치한 Chrome 등의 브라우저에서 geumjeongschool.com에 접속하여 사이트 권한을 직접 허용해 주세요.
      </PermissionGuide>
